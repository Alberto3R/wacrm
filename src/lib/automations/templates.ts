  ...
  out_of_office: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Obrigado pela sua mensagem! Nossa equipe está offline no momento (das 9h às 18h) e responderá logo cedo amanhã.",
        },
        parent_index: 0,
        branch: 'yes',
      },
  ...
  follow_up_reminder: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Só retomando o contato — ficou alguma outra dúvida? Será um prazer ajudar!",
        },
      },
    ],
  },
